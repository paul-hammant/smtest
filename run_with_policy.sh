...
~/.jdks/corretto-21.0.6/bin/java -Djava.security.manager -Djava.security.policy=security.policy -cp core/target/core-1.0-SNAPSHOT.jar com.example.ReflectiveHttpClientCaller "$1"
